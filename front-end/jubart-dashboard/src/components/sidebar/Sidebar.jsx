          ...
          <li className="sidebar-item">
              <a href="#" className="sidebar-link">
                <i class="bi bi-motherboard">
                  <svg xmlns="http://www.w3.org/2000/svg"  fill="currentColor" class="bi bi-motherboard" viewBox="0 0 16 16">
              ...
              <li className="sidebar-item sub-item">
                <a href="#" className="sidebar-link has-dropdown collapsed"
                  ...
                  <i className="bi bi-clipboard-pulse">
                    <svg xmlns="http://www.w3.org/2000/svg"  fill="currentColor" class="bi bi-clipboard-pulse" viewBox="0 0 16 16">
    ...
    {/* Aba Contato */}
          <li className="sidebar-item">
              ...
              <i class="bi bi-person-rolodex">
                <svg xmlns="http://www.w3.org/2000/svg"  fill="currentColor" class="bi bi-person-rolodex" viewBox="0 0 16 16">
