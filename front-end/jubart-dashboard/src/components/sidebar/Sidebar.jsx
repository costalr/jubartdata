...
import React, {useState} from 'react';
  ...
  return (
    ...
    <aside id="sidebar" className={`sidebar ${sidebarOpen ? 'expand' : ''}`}>
      <div className="e-flex">
        <div className="sidebar-toggle">

            {/* Toggle Icon */}
          <button id="toggle-sidebar-btn" onClick={toggleSidebar}>
          <i className="bi bi-list" id="toggle-sidebar-btn">
          ...
          <li className="sidebar-item">
              <a href="#" className="sidebar-link">
                <i className="bi bi-motherboard">
                  <svg xmlns="http://www.w3.org/2000/svg"  fill="currentColor" className="bi bi-motherboard" viewBox="0 0 16 16">
    ...
    {/* Aba Paineis */}
          <li className="sidebar-item ">
            <a href="#" className="sidebar-link has-dropdown collapsed"
              data-bs-toggle="collapse"
              data-bs-target="#panels"
              aria-expanded="false"
              aria-controls="panels">
              <i className="bi bi-clipboard2-data">
                <svg xmlns="http://www.w3.org/2000/svg"  fill="currentColor" className="bi bi-clipboard2-data" viewBox="0 0 16 16">
    ...
    {/* Subaba Comex */}
            <ul id="panels" className="sidebar-dropdown list-unstyled collapse"
              data-bs-parent="#sidebar">
              <li className="sidebar-item sub-item">
                <a href="#" className="sidebar-link has-dropdown collapsed"
                  data-bs-toggle="collapse"
                  data-bs-target="#comex"
                  aria-expanded="false"
                  aria-controls="comex">
                  <i className="bi bi-clipboard-pulse">
                    <svg xmlns="http://www.w3.org/2000/svg"  fill="currentColor" className="bi bi-clipboard-pulse" viewBox="0 0 16 16">
                ...
                <ul id="comex" className="sidebar-dropdown list-unstyled collapse" data-bs-parent="#panels">

    {/* Subabas Comex */}
                  <li className="sidebar-item sub-sub-item">
                    <a href="#" className="sidebar-link">
                  ...
                  <li className="sidebar-item">
                    <a href="#" className="sidebar-link  sub-sub-item">
    ...
    {/* Subaba FAO */}
              <li className="sidebar-item sub-item">
                ...
                <ul id="fao" className="sidebar-dropdown list-unstyled collapse" data-bs-parent="#panels">
    ...
    {/* Subaba IBGE */}
              <li className="sidebar-item sub-item">
                ...
                <ul id="ibge" className="sidebar-dropdown list-unstyled collapse" data-bs-parent="#panels">
    ...
    {/* Aba Contato */}
          <li className="sidebar-item">
              ...
              <i className="bi bi-person-rolodex">
                <svg xmlns="http://www.w3.org/2000/svg"  fill="currentColor" className="bi bi-person-rolodex" viewBox="0 0 16 16">
